    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/avatar.png" alt="Image"/></a></div>
          <div class="h2 title">Bakhyt Tomiris</div>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Hello! I am Bakhyt Tomiris. Web Developer, Graphic Designer.</p>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row mt-3">
              ...
              <div class="col-sm-8">190103269@stu.sdu.edu.kz</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">+707-810-80-19</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8">Kazalhstan, Almaty</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Language:</strong></div>
              <div class="col-sm-8">English, Kazakh, Russian, Turkish</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">student of the lyceum</div>
            <p class="category">KTL</p>
            <p>“BILIM-INNOVATION” (former “KATEV”) is an International educational fund which was created in order to promote cooperation in the field of education between Kazakhstan and Turkey by direct support of presidents Nursultan Nazarbayev and Turgut Ozal.</br>“BILIM-INNOVATION” consists of 27 public lyceums, 3 private lyceums, 2 international shcools (“SPECTRUM” in Astana and “GALAXY INTERNATIONAL” in Almaty), 2 colleges in Almaty and Taraz as well as 3 Memorandum based schools in Atyrau, Kulsary and Ekibastuz.</p>
          </div>
        </div>
      </div>
    </div>
    <div class="card">
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-education-header">
            <p>2019-2023</p>
            <div class="h5">Suleyman Demirel University</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Information System</div>
            <p class="category">University of SDU</p>
            <p>Süleyman Demirel University (Kazakh: Сүлейман Демирел атындағы Университет, romanized: Súleıman Demırel atyndaǵy Ýnıversıtet, Russian: Университет имени Сулеймана Демиреля,Turkish: Süleyman Demirel Üniversitesi, abbreviated as SDU) is a private university in Kaskelen, Almaty, Kazakhstan. It is named after Süleyman Demirel, the former prime minister and president of Turkey.</br>The university was established in 1996, by the initiatives of the president of Kazakhstan, Nursultan Nazarbayev, and the former president of Turkey, Suleyman Demirel.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="section" id="contact">
  <div class="cc-contact-information" style="background-image: url('images/staticmap.png');">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="pb-2">Kazakhstan, Almaty</p>
                    <p class="mb-0"><strong>Phone</strong></p>
                    <p class="pb-2">+7 707 810 8019</p>
                    <p class="mb-0"><strong>Email</strong></p>
                    <p>190103269@stu.sdu.edu.kz</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <footer class="footer">
      ...
      <div class="h4 title text-center">Bakhyt Tomiris Erlankyzy</div>
